...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock, reset & status pins of ethernet_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins ethernet_0/m_axi]
	connect_bd_net [get_bd_pins ethernet_0/m_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ethernet_0/m_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ethernet_0/m_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins ethernet_0/m_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins ethernet_0/m_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]

	# Connect all clock & reset of ethernet_0 streaming interfaces..
	connect_bd_net [get_bd_pins ethernet_0/s_axis_rxd_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ethernet_0/s_axis_rxd_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ethernet_0/s_axis_rxs_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ethernet_0/s_axis_rxs_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ethernet_0/m_axis_txd_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ethernet_0/m_axis_txd_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ethernet_0/m_axis_txc_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ethernet_0/m_axis_txc_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of ethernet_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {ethernet_0/m_axi/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_m_axi_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells ethernet_0]

	# Copy all address to ethernet_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ethernet_v1_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ethernet_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ethernet_v1_0_hw_${i}"

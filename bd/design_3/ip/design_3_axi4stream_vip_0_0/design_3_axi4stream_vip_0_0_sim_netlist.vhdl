...
entity design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top is
  port (
    aclk : in STD_LOGIC;
  ...
  attribute C_AXI4STREAM_DATA_WIDTH of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 32;
  attribute C_AXI4STREAM_DEST_WIDTH : integer;
  attribute C_AXI4STREAM_DEST_WIDTH of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 0;
  attribute C_AXI4STREAM_HAS_ARESETN : integer;
  attribute C_AXI4STREAM_HAS_ARESETN of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 1;
  attribute C_AXI4STREAM_ID_WIDTH : integer;
  attribute C_AXI4STREAM_ID_WIDTH of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 0;
  attribute C_AXI4STREAM_INTERFACE_MODE : integer;
  attribute C_AXI4STREAM_INTERFACE_MODE of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 0;
  attribute C_AXI4STREAM_SIGNAL_SET : string;
  attribute C_AXI4STREAM_SIGNAL_SET of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is "32'b00000000000000000000000000010111";
  attribute C_AXI4STREAM_USER_BITS_PER_BYTE : integer;
  attribute C_AXI4STREAM_USER_BITS_PER_BYTE of design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top : entity is 0;
...
entity design_3_axi4stream_vip_0_0 is
  ...
  attribute NotValidForBitStream of design_3_axi4stream_vip_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_3_axi4stream_vip_0_0 : entity is "design_3_axi4stream_vip_0_0,axi4stream_vip_v1_1_4_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_3_axi4stream_vip_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_3_axi4stream_vip_0_0 : entity is "axi4stream_vip_v1_1_4_top,Vivado 2018.3.1";
end design_3_axi4stream_vip_0_0;

architecture STRUCTURE of design_3_axi4stream_vip_0_0 is
  ...
  attribute C_AXI4STREAM_SIGNAL_SET : string;
  attribute C_AXI4STREAM_SIGNAL_SET of inst : label is "32'b00000000000000000000000000010111";
  attribute C_AXI4STREAM_USER_BITS_PER_BYTE : integer;
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLOCK, ASSOCIATED_BUSIF S_AXIS:M_AXIS, ASSOCIATED_RESET ARESETN, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_3_aclk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tlast : signal is "XIL_INTERFACENAME M_AXIS, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_3_aclk, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_tready : signal is "xilinx.com:interface:axis:1.0 M_AXIS TREADY";
  attribute X_INTERFACE_INFO of m_axis_tstrb : signal is "xilinx.com:interface:axis:1.0 M_AXIS TSTRB";
  attribute X_INTERFACE_INFO of m_axis_tvalid : signal is "xilinx.com:interface:axis:1.0 M_AXIS TVALID";
begin
inst: entity work.design_3_axi4stream_vip_0_0_axi4stream_vip_v1_1_4_top
     port map (
      aclk => aclk,
      aclken => '1',
      aresetn => aresetn,

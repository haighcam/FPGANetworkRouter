...
`timescale 1 ns / 1 ps
	...
	(
		...
		output wire [C_M_AXIS_TUSER_WIDTH-1 : 0] m_t_user,
...
// Instantiation of Axi Bus Interface S_AXIS
	...
	assign m_axis_tstrb	= {(C_AXIS_TDATA_WIDTH/8){1'b1}};
	...
	begin
	  if(!aresetn)
	    ...
	    if (write_pointer <= NUMBER_OF_WORDS-1)
	      begin
	        if (fifo_wren)
	          begin
	          ...
	          if ((write_pointer == NUMBER_OF_WORDS-1)|| s_axis_tlast || s_axis_tstrb != 4'b1111)
	            begin
